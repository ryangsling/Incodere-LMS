...
Multi-role LMS for corporate training. Three user roles: super admin (Incodere staff), company admin (client HR/training managers), and learner (employees).
...
- `super@incodere.com` / `SuperAdmin123!` (super admin)
