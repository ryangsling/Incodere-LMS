# ILMS - Incodere Learning Management System

## Business Requirements

This project is building ILMS, an LMS (Learning Management System) for Incodere. Key features:
...
- A super admin (Incodere) can manage all organisations, courses, and users
...
- `super_admin` - Incodere staff. Manages organisations and the course catalogue.
