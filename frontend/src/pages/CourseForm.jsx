...
export default function CourseForm() {
  ...
  return (
    <div className="max-w-xl">
      <h2 className="text-xl font-bold text-[#032147] mb-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label className="block text-sm text-[#888888] mb-1">Thumbnail</label>
          <input
            type="file"
            accept="image/*"
            onChange={e => {
          ...
          {thumbnailUrl && !thumbnail && (
            <p className="text-xs text-[#888888] mt-1">Current thumbnail uploaded</p>
          )}
        </div>
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="px-4 py-2 rounded text-sm border border-gray-300 text-[#888888] hover:bg-gray-50"
          >
            Cancel
          </button>
        </div>
