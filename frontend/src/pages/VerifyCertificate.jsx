...
export default function VerifyCertificate() {
  ...
  return (
    <div className="min-h-dvh bg-canvas flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full">
        ...
        {error && (
          <Card>
            <CardBody className="text-center">
              ...
              <h1 className="text-lg font-bold text-ink mb-2">Certificate Not Found</h1>
        ...
        {data?.valid && (
          <Card>
            <CardBody className="text-center">
              <CheckBadgeIcon className="mx-auto size-16 text-link mb-4" />
              <Badge variant="success" className="mb-3">Verified</Badge>
              <h1 className="text-lg font-bold text-ink mb-1">{data.learner_name}</h1>
              <p className="text-sm text-muted mb-4">has successfully completed</p>
              <p className="text-base font-semibold text-link mb-4">{data.course_title}</p>
              ...
              {user && (
                <button
                  ...
                  className="inline-flex items-center gap-2 mt-5 text-sm font-semibold text-link hover:opacity-80"
                >
        ...
        <p className="text-center text-xs text-muted mt-6">
          <Link to="/" className="hover:text-link">Return to ILMS</Link>
        </p>
      </div>
    </div>
  )
