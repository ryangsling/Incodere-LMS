...
const seed = async () => {
  ...
  const users = [
    { email: 'super@incodet.com', password: 'SuperAdmin123!', role: 'super_admin', first_name: 'Super', last_name: 'Admin', org_id: null },
  ...
  console.log('  super@incodet.com / SuperAdmin123!')
